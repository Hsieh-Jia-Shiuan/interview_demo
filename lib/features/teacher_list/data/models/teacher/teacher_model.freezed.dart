...
mixin _$TeacherModel {
  ...
  List<CurriculumModel> get curriculums => throw _privateConstructorUsedError;
...
class _$TeacherModelImpl implements _TeacherModel {
  ...
  @override
  String toString() {
    return 'TeacherModel(id: $id, name: $name, title: $title, avatarUrl: $avatarUrl, curriculums: $curriculums)';
  }
